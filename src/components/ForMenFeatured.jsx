    ...
    <div className="mt-[59px] px-[45px] relative pt-[130px]">
      ...
      <div className="flex justify-between items-end aspect-[135/56]">
        <div className="basis-[20.4%]">
          <div className="home__for-men mb-[13px] overflow-hidden">
            <img
